...
class PseudoResultSet(values: Array<out Pair<String, Any?>>) : ResultSet {
    private val values = mutableMapOf(*values)
    ...
    override fun getArray(p0: Int): SQLArray {
        TODO("Not yet implemented")
    }

    override fun getArray(p0: String?): SQLArray {
        TODO("Not yet implemented")
    }
    ...
    override fun updateArray(p0: Int, p1: SQLArray?) {
        TODO("Not yet implemented")
    }

    override fun updateArray(p0: String?, p1: SQLArray?) {
        TODO("Not yet implemented")
    }
